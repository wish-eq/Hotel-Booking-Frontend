...
import styles from "@/app/styles/FontPage.module.css"
            ...
            <div className="relative">
                ...
                <div className="text-white font-medium text-[30px] text-center pt-4 relative">
                        <div className="flex flex-col space-y-3">
                            ...
                            <Link className="bg-slate-950 text-gray-300 border-2 border-white border-opacity-100
          font-semibold py-2 px-2 rounded-lg transition-colors duration-300 hover:bg-black 
          hover:text-white hover:border-transparent" href={"/auth/signin"}>Sign In / Register Here !
                            </Link>
                        </div>
                </div>
            </div>
